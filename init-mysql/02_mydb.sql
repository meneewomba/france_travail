...
CREATE TABLE IF NOT EXISTS `mydb`.`job_competency` (
  ...
  CONSTRAINT `competencies_fk`
    ...
    REFERENCES `mydb`.`competencies` (`competency_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`offers_evolution`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`offers_evolution` ;

CREATE TABLE IF NOT EXISTS `mydb`.`offers_evolution` (
  `date` DATE NOT NULL,
  `job_offers` INT NULL,
  `dept` INT NOT NULL,
